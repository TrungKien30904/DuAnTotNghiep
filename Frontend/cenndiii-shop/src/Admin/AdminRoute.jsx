...
import Products from "./pages/Atribute/Products/Products";
import ShoeCollar from "./pages/Atribute/ShoeCollar";
import ShoeSoles from "./pages/Atribute/ShoeSoles";
import Toe from "./pages/Atribute/Toe";
import Brand from "./pages/Atribute/Brand";
import Material from "./pages/Atribute/Material";
import Suppliers from "./pages/Atribute/Suppliers";
import Color from "./pages/Atribute/Color";
import Size from "./pages/Atribute/Size";
import Discounts from "./pages/Discounts/Discounts";
import Coupons from "./pages/Coupon/Coupons";
import Categories from "./pages/Atribute/Categories";
import ProductsDetails from "./pages/Atribute/Products/ProductDetails";
import ProductsManager from "./pages/Atribute/Products/ProductsManager";
