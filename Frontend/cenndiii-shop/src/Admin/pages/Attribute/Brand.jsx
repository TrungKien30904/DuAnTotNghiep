...
export default function Brand() {
  ...
  const handleSaveEdit = async (updatedRow) => {
    const response = await api.post("/admin/thuong-hieu/sua", {
      idThuongHieu: updatedRow.idThuongHieu,
      ten: updatedRow.ten,
  ...
  const columns = [
    ...
    { field: 'ten', headerName: 'Tên thương hiệu', flex: 1 },
    {
      field: 'trangThai',
