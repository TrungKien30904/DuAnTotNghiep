...
export default function EditDiscounts() {
  ...
  useEffect(() => {
    if (!sanPhamChiTiets || (sanPhamChiTiets && sanPhamChiTiets.length <= 0)) return;
        ...
        <div className="grid grid-cols-5 gap-4">
          <div className="relative text-sm col-span-2">
            ...
            <input
              ...
              type="text"
              name="maDotGiamGia"
              value={editMaDGG.idDotGiamGia}
              readOnly
              onChange={(e) => editDGG({ ...editMaDGG, idDotGiamGia: e.target.value })}
