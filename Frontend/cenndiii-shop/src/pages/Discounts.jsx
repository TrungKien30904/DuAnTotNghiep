          ...
          <tbody>
            {dotGiamGias.map((dotGiamGia, index) => (
              <tr key={dotGiamGia.idDotGiamGia} className="border-t text-center">
                ...
                <td className="p-2">{dotGiamGia.idDotGiamGia}</td>
                ...
                <td className="p-2 ">
                  <span 
                    className={`px-2 py-1 rounded w-29 text-center border
                      ${dotGiamGia.trangThai === 2
                        ? "bg-yellow-300 text-yellow-800 border-yellow-800" 
                        : dotGiamGia.trangThai === 1
                          ? "bg-green-300 text-green-800 border-green-800" 
                          : "bg-orange-200 text-orange-800 border-orange-800"}`}
                  >
                    {dotGiamGia.trangThai === 2 ? "Sắp diễn ra" : dotGiamGia.trangThai === 1 ? "Đang diễn ra" : "Bị vô hiệu hóa"}
                  </span>
                </td>
