...
export default function CouponDetails() {
    ...
    const validateField = (name, value) => {
        ...
        switch (name) {
            ...
            case 'hinhThuc':
                ...
                else delete tempErrors.hinhThuc;
                break;
            case 'giaTri':
            ...
            case 'soLuong':
                ...
                break;
            case 'dieuKien':
                if (value < 0) tempErrors.dieuKien = "Điều Kiện Không Được Âm";
                else delete tempErrors.dieuKien;
                break;
            case 'giaTriToiDa':
                if (value < 0) tempErrors.giaTriToiDa = "Giá Trị Tối Đa Không Được Âm";
    ...
    const validate = () => {
        ...
        if (coupon.dieuKien < 0) tempErrors.dieuKien = "Điều Kiện Không Được Âm";
        if (coupon.giaTriToiDa < 0) tempErrors.giaTriToiDa = "Giá Trị Tối Đa Không Được Âm";
    ...
    const handleUpdateCoupon = async () => {
        if (validate()) {
            ...
            try {
                ...
                navigate('/coupons', { state: { message: `Cập nhật thành công phiếu giảm giá có mã: ${coupon.maKhuyenMai}` } });
            } catch (error) {
    ...
    const handleCreateNewCoupon = () => {
        ...
        navigate('/add-coupon', {state: {couponData: newCouponData}});
    };
                ...
                <div className="bg-white p-4 rounded-lg shadow-md"
                    ...
                    <form onSubmit={(e) => {
                        ...
                        <div className="flex space-x-4 mb-4">
                            ...
                            {coupon.hinhThuc === '%' && (
                                <div className="flex-1">
                                    <label className="block text-sm font-semibold mb-2">Giá Trị Tối Đa</label>
                                    <input
                                        type="number"
                                        name="giaTriToiDa"
                        ...
                        <div className="flex space-x-4 mb-4">
                            ...
                            <div className="flex-1">
                                <label className="block text-sm font-semibold mb-2">Điều Kiện Áp Dụng</label>
                                <input
                                    type="number"
                                    name="dieuKien"
