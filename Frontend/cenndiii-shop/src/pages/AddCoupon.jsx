...
function AddCoupon() {
    ...
    const validate = () => {
        ...
        if (formData.dieuKien < 0) tempErrors.dieuKien = "Điều Kiện Không Được Âm";
        if (formData.giaTriToiDa < 0) tempErrors.giaTriToiDa = "Giá Trị Tối Đa Không Được Âm";
                        ...
                        <div className="flex space-x-4 mb-4">
                            ...
                            <div className="flex-1">
                                ...
                                <input
                                    type="number"
                                    name="dieuKien"
                                    value={formData.dieuKien === 0 ? '' : formData.dieuKien}
                                    onChange={handleChange}
                                    onKeyDown={handleKeyDown}
                                    onBlur={() => {
